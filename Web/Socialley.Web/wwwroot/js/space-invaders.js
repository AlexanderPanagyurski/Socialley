...
function drawStartScreen() {
    ...
    fillBlinkingText("Press X to shoot!", CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, 500, '#FFFFFF', 36);
    fillBlinkingText("Press enter to play!", CANVAS_WIDTH / 2, CANVAS_HEIGHT / 4, 500, '#FFFFFF', 36);
}
